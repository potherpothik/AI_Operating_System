...
EXPECTED_OUTPUT_SCHEMA = {
    ...
    "action": "str",
    "target_repo": "optional_str",
    "target_branch": "optional_str",
    "symbol_ref": "optional_str",
    "target_approval_id": "optional_str",
}


def ensure_template_registered(created_by: str = "code_review_agent_startup") -> dict:
