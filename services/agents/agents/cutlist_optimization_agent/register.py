...
TEMPLATE_ID = "cutlist_optimization_agent"
...
EXPECTED_OUTPUT_SCHEMA = {
    ...
    "action": "str",
    "stock_length": "optional_str",
    "cut_lengths_json": "optional_str",
    "kerf": "optional_str",
}


def ensure_template_registered(created_by: str = "cutlist_optimization_agent_startup") -> dict:
